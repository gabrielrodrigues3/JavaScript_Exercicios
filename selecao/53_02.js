...
let tabela = "<table class='table'>";
    ...
    for (var i = 0; i < listDados.length; i++) { tabela +="<tr>" ; tabela +="<td>" + listDados[i].nota1 + "</td>" ;
        tabela +="<td>" + listDados[i].nota2 + "</td>" ; tabela +="<td>" + listDados[i].nota3 + "</td>" ; tabela
        +="<td>" + listDados[i].nota4 + "</td>" ; tabela +="<td>" + listDados[i].resultado + "</td>" ; tabela +="<td>" +
        listDados[i].media + "</td>" ; tabela +="</tr>" ; } tabela +="</table>" ;
